# ตั้งค่าหน้า /upload — ทางสำรอง (Apps Script)

> **ปกติไม่ต้องทำ:** ถ้า deploy บน Vercel หน้า /upload ทำงานผ่าน `api/upload.js` อยู่แล้ว
> (Claude ตั้ง env ให้ตอน "ติดตั้งระบบสลิป") — ใช้วิธีนี้เฉพาะเมื่อไม่มี Vercel
